...
import { NewArrivalsContext } from "../../contexts/homePage/NewArrivalsContext";
...
const NewArrival = () => {
  ...
  return (
    <div className="m-10">
      <h1 className="text-4xl text-slate-700 font-semibold p-2 mb-2 ml-2">New Arrivals</h1>
      <div className="grid mobile:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {newArrivals.map((newItem) => {
          return (
            <div key={newItem.id} className="flex-1 mx-2  rounded border-[1px] relative group cursor-pointer">
              {/* image */}
              <div className="p-10 flex justify-center items-center group-hover:opacity-50 bg-[#f3f3f3]">
