    ...
    return (
      <div>
        <div className="bg-white drop-shadow-[0_1px_5px_rgba(0,0,0,0.20)] px-6 py-6 mx-4 flex justify-between items-center">
          ...
          {/* Order view Button */}
          <Link to='/account/write-review/' className="border border-pink-500 text-pink-500 rounded-md hover:text-white hover:bg-pink-400 flex justify-center items-center py-2 px-6 duration-500">
            Write Review
          </Link>
        </div>
      </div>
